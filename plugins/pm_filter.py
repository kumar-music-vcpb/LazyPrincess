...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url='https://t.me/Requested_Zone'),
        ] 
    )
    if 0 < offset <= 10:
        off_set = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @Kumar_Manis ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You LazyXDeveloper ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⪦ 𝕄𝕆𝕍𝕀𝔼 ℂℍ𝔸ℕℕ𝔼𝕃 ⪧', url='https://t.me/Requested_Zone')
        ],[
            InlineKeyboardButton('💸 E𝐚𝐫𝐧 M𝐨𝐧𝐞𝐲 💸', callback_data="shortlink_info")
        ],[
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE YT Channel 🦋", url='https://telegram.me/share/url?url=https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw'
                )
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = InlineKeyboardMarkup(
            ...
            InlineKeyboardButton('💤Developer', url='https://t.me/Kumar_Manis')
            ],[
            InlineKeyboardButton('🔐 Close', callback_data='close_data')
            ]]
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 ══• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •══ 🐞", url=f"https://telegram.me/share/url?url=https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw")
            ]]
            btn_lzdv = [
                [
    ...
    if imdb and imdb.get('poster'):
        try:
            z = await message.reply_photo(photo=imdb.get('poster'), caption=cap[:1024],
                                        reply_markup=InlineKeyboardMarkup(btn))
            thanksaa = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Kumar_Manis'>𓆩• LazyXDeveloper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            ...
            thanks = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Kumar_Manis'>𓆩• LazyXDeveloper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
            await thanks.delete()
            if SELF_DELETE:
                await asyncio.sleep(SELF_DELETE_SECONDS)
            ...
            thanksz = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Kumar_Manis'>𓆩• LazyXDeveloper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
        ...
        thanksx = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Kumar_Manis'>𓆩• Nacked_Eye •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
        await asyncio.sleep(5)
